...
{
    public static string TripleDesCbcEncrypt(string szText, string szKey, string szIv = Common.C_3DESAPPVECTOR)
    {
        try
        {
            TripleDESCryptoServiceProvider obj3Des = new()
            {
                ...
                Mode = CipherMode.CBC,
                Key = ConvertUtilities.btHexToByte(szKey)
            };
    ...
    public static string TripleDesCbcDecrypt(string szText, string szKey, string szIv = Common.C_3DESAPPVECTOR)
    {
        try
        {
            TripleDESCryptoServiceProvider obj3Des = new()
