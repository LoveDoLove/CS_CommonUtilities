...
/// <summary>
/// Provides extension methods for <see cref="IServiceCollection"/> to facilitate the registration of CRON job services.
/// </summary>
public static class ScheduledServiceExtensions
{
    ...
    /// Thrown if <paramref name="options"/> is null, or if the <see cref="IScheduleConfig{T}.CronExpression"/> within the options is null, empty, or whitespace.
    /// </exception>
