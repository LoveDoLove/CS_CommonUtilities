...
public interface IGoogleMfaService
{
    ...
    /// </summary>
    /// <param name="issuer">The name of the issuer (e.g., your application or company name) to be displayed in the authenticator app.</param>
    /// <param name="email">The user's email address or username, used to identify the account in the authenticator app.</param>
    /// <returns>A <see cref="GoogleMfa"/> object containing the manual setup key, QR code image URL (or Base64 image), and other relevant details.</returns>
