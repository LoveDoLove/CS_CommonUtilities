...
public interface IImageService
{
    ...
    /// <param name="folder">The name of the folder (or subpath) where the photo should be saved.
    /// This is typically relative to a preconfigured base storage path.</param>
    /// <returns>
    ...
    /// <param name="folder">The name of the folder (or subpath) where the photo is located.
    /// This is typically relative to a preconfigured base storage path.</param>
