...
public interface IMailerService
{
    ...
    /// </summary>
    /// <param name="mail">A <see cref="Mail"/> object containing all the necessary information for sending the email,
    /// such as recipient(s), sender, subject, body, and any attachments.</param>
    /// <returns>
