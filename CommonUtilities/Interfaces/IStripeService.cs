...
public interface IStripeService
{
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the created <see cref="TaxRate"/> object if successful;
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the created <see cref="Customer"/> object if successful;
    /// otherwise, <c>null</c> if creation failed.
    /// </returns>
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the created <see cref="Session"/> object if successful;
    /// otherwise, <c>null</c> if creation failed.
    /// </returns>
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the <see cref="Session"/> object if found;
    /// otherwise, <c>null</c>.
    /// </returns>
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the <see cref="PaymentIntent"/> object if found;
    /// otherwise, <c>null</c>.
    /// </returns>
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the <see cref="Charge"/> object if found;
    /// otherwise, <c>null</c>.
    /// </returns>
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the <see cref="Customer"/> object if found;
    /// otherwise, <c>null</c>.
    /// </returns>
    ...
    /// <param name="amount">The amount to refund. If null, a full refund is attempted. Note: Stripe's API might require specific handling for partial vs full refunds.</param>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the <see cref="Refund"/> object if the refund was successful;
    /// otherwise, <c>null</c>.
    /// </returns>
    Task<Refund?> RefundPaymentIntentAsync(string paymentIntentId, decimal amount); // Consider if 'amount' should be nullable for full refunds, or if specific options object is better.
}