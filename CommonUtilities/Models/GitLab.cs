...
public class GitLab
{
    //public const string GitLabIpAddress = "10.36.28.88";
    //public const string GitlabAccessToken = "glpat-NDo2Njy5CLdTTYSqNCEy";
    //public const string GitlabAccessPrivateToken = "glpat-sHaFpiMRJ33Dz2ycVNUZ";
