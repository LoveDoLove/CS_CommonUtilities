namespace CommonUtilities.Services.Scheduler;

/// <summary>
///     Defines the configuration for a scheduled job of type <typeparamref name="T" />.
/// </summary>
/// <typeparam name="T">
///     The type of the job being configured. This type parameter allows for specific configurations if
///     needed, though it's not strictly used by the properties in this interface.
/// </typeparam>
...
public class ScheduleConfig<T> : IScheduleConfig<T>
{
    ...
    /// <summary>
    ///     Gets or sets the <see cref="System.TimeZoneInfo" /> for the CRON schedule.
    ///     Defaults to <see cref="TimeZoneInfo.Local" />, the local time zone of the server.
    /// </summary>
